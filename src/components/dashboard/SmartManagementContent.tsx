...
export const SmartManagementContent: React.FC<SmartManagementContentProps> = ({ role }) => {
  ...
  return (
    <div className="space-y-8 animate-fade-up">
      {/* Header Section */}
      <div className="bg-gradient-to-r from-[#0F172A] to-[#1e293b] rounded-3xl p-8 relative overflow-hidden shadow-xl">
        <div className="absolute top-0 right-0 w-64 h-64 bg-[#D4AF37]/10 rounded-full blur-3xl -mr-10 -mt-10"></div>
        <div className="relative z-10 text-white">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 rounded-2xl bg-white/10 backdrop-blur-sm flex items-center justify-center text-[#D4AF37] border border-white/5">
              <Brain size={24} />
            </div>
            <span className="bg-[#D4AF37] text-[#0F172A] text-xs font-bold px-3 py-1 rounded-full">BETA v2.0</span>
          </div>
      ...
      {isCorporate ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white p-6 rounded-2xl border border-gray-200/60 shadow-sm hover:border-[#D4AF37]/50 transition-all group cursor-pointer">
               <div className="flex justify-between items-start mb-4">
                  ...
                  <ArrowRight size={20} className="text-gray-300 group-hover:text-[#D4AF37] -rotate-45 transition-colors" />
               </div>
               <h3 className="text-lg font-bold text-[#0F172A] mb-2">تحسين المحفظة الاستثمارية</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               <div className="bg-white p-6 rounded-2xl border border-gray-200/60 shadow-sm hover:border-[#D4AF37]/50 transition-all group cursor-pointer">
                  ...
                  <h3 className="font-bold text-[#0F172A] mb-1">التقارير التلقائية</h3>
               ...
               <div className="bg-white p-6 rounded-2xl border border-gray-200/60 shadow-sm hover:border-[#D4AF37]/50 transition-all group cursor-pointer">
                  ...
                  <h3 className="font-bold text-[#0F172A] mb-1">حاسبة السيولة</h3>
          ...
          <div className="bg-[#F8FAFC] rounded-2xl p-6 border border-gray-200/60">
             ...
             <button className="w-full mt-6 py-3 bg-[#0F172A] text-white rounded-xl text-sm font-bold hover:bg-gray-800 transition-colors">
                عرض التقرير الكامل
             </button>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-2xl border border-gray-200/60 p-6 shadow-sm relative overflow-hidden">
             ...
             <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div className="flex items-center gap-4">
                   <div className="w-16 h-16 rounded-full bg-gray-100 p-1 border-2 border-[#D4AF37]/30">
                   ...
                   <div>
                      <h3 className="text-xl font-bold text-[#0F172A] flex items-center gap-2">
                         مرحباً، محمد أحمد
                         <span className="bg-[#D4AF37]/10 text-[#D4AF37] text-[10px] px-2 py-0.5 rounded-full border border-[#D4AF37]/20">عضوية ذهبية</span>
                      </h3>
                ...
                <div className="flex gap-4 w-full md:w-auto">
                   ...
                   <div className="flex-1 md:flex-none bg-gray-50 px-6 py-3 rounded-xl border border-gray-100 text-center">
                      ...
                      <p className="text-sm font-bold text-[#0F172A]">2,500,000 SAR</p>
                   </div>
                </div>
             </div>
             ...
             <div className="mt-8 pt-6 border-t border-gray-100">
                <p className="text-sm font-bold text-[#0F172A] mb-4">حالة الطلب الحالي: <span className="text-[#D4AF37]">فيلا سكنية - حي النرجس</span></p>
                <div className="relative flex items-center justify-between">
                   <div className="absolute top-1/2 left-0 w-full h-1 bg-gray-100 -z-10 -translate-y-1/2 rounded-full"></div>
                   <div className="absolute top-1/2 right-0 w-2/3 h-1 bg-[#0F172A] -z-10 -translate-y-1/2 rounded-full transition-all duration-1000"></div>
                   ...
                   {[
                     ...
                     { step: 5, label: 'الإفراغ', active: false },
                      ...
                      <div key={s.step} className="flex flex-col items-center gap-2 bg-white px-2">
                         ...
                         <span className={`text-[10px] font-bold ${s.active ? 'text-[#0F172A]' : 'text-gray-400'}`}>{s.label}</span>
                      </div>
                   ))}
                </div>
             </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
             {/* Main Advisor Card */}
             <div className="md:col-span-2 bg-gradient-to-br from-[#0F172A] to-[#1e293b] rounded-2xl p-6 text-white relative overflow-hidden group cursor-pointer">
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#D4AF37]/20 rounded-full blur-2xl -mr-10 -mt-10"></div>
                <div className="relative z-10 h-full flex flex-col justify-between">
                   <div>
                      <div className="w-10 h-10 rounded-lg bg-white/10 backdrop-blur-md flex items-center justify-center text-[#D4AF37] mb-4 border border-white/5">
                         <Sparkles size={20} />
                      </div>
                   ...
                   <button className="flex items-center gap-2 text-[#D4AF37] font-bold text-sm hover:gap-3 transition-all">
             ...
             {[
               ...
               { title: 'حجز موعد معاينة', icon: Calendar, color: 'text-orange-600', bg: 'bg-orange-50' },
                ...
                <button key={idx} className="bg-white p-6 rounded-2xl border border-gray-200/60 shadow-sm hover:shadow-md hover:border-[#D4AF37]/30 transition-all flex flex-col items-center justify-center text-center group">
                   ...
                   <h4 className="font-bold text-[#0F172A] text-sm group-hover:text-[#D4AF37] transition-colors">{service.title}</h4>
                </button>
             ))}
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200/60 p-6 shadow-sm">
             <div className="flex items-center justify-between mb-6">
                ...
                <button className="text-xs font-bold text-gray-400 hover:text-[#0F172A]">عرض المزيد</button>
             </div>
             
             <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[1, 2, 3].map((item) => (
                   <div key={item} className="group border border-gray-100 rounded-xl p-3 hover:border-[#D4AF37] transition-all cursor-pointer">
                      <div className="relative h-32 rounded-lg overflow-hidden mb-3">
                         ...
                         <span className="absolute top-2 right-2 bg-white/90 backdrop-blur-sm px-2 py-1 rounded-md text-[10px] font-bold text-[#0F172A]">مكة المكرمة</span>
                      </div>
                      <h4 className="font-bold text-[#0F172A] text-sm mb-1 truncate">فيلا درج صالة - حي العوالي</h4>
                      <div className="flex items-center justify-between">
                         <span className="text-xs text-gray-500">المساحة: 450م²</span>
                         <span className="text-sm font-black text-[#D4AF37]">1.2M</span>
                      </div>
                   </div>
                ))}
             </div>
